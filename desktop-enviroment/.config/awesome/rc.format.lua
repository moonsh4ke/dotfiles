...
awful.layout.layouts = {
    awful.layout.suit.spiral, awful.layout.suit.floating,
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = {
        "1 main", "2 www", "3 edit", "4 floating", "5", "6", "7", "8", "9"
    }
    local l = awful.layout.suit -- Just to save some typing: use an alias.
    local layouts = {
        l.spiral, l.spiral, l.spiral, l.floating, l.spiral, l.spiral,
        l.tile.spiral, l.spiral, l.spiral
    }
